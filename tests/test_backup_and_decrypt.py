"""
Unit tests for backup, restore, decrypt, and push configuration utilities:
- perform_backup with non-existent or corrupt database
- prune_old_backups retention filtering
- restore_backup verify_only mode and wrong key handling
- decrypt_database error handling (missing file, invalid key, wrong key, corrupt payload)
- _load_allowed_push_domains provider merging and error validation
"""
...
def test_perform_backup_integrity_check_failure(tmp_path, monkeypatch):
    ...
    # Simulate SQLite integrity check returning False
...
def test_prune_old_backups(tmp_path):
    ...
    # Set old_file modification time to 40 days ago
...
def test_restore_backup_verify_only_mode(tmp_path):
    ...
    # In verify_only mode, must return True for valid backup and NOT touch/create target_db
...
def test_restore_encrypted_backup_wrong_key_fails(tmp_path):
    ...
    # Restoring with wrong key fails gracefully
...
def test_decrypt_database_valid_workflow(tmp_path):
    ...
    # Verify content in decrypted database
...
# =====================================================================
# _load_allowed_push_domains tests
# =====================================================================
